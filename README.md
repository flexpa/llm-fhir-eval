...
2. **Unstructured Encounter Profile Extraction** (extract-unstructured-encounter-profile-first-experiment.yaml)
...
3. **Unstructured Data Extraction** (extract-unstructured.yaml)
...
4. **FHIR Path Evaluation** (fhir-path.yaml)
...
5. **Tool Use Validation** (tool-use-validator.yaml)
...
5. **FHIR-GPT Prompt Evaluation** (fhir-gpt.yaml)
